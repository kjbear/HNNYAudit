           ...
           <div class="col-md-2 hidden-sm hidden-xs">
               <div class="panel panel-default">
                   <div class="panel-body">
                       @if (true)
                           {!! Form::open(['method' => 'DELETE','action' => ['Cognition\EtiBrowserController@destroy', $doc->id], 'id' => 'delete_form']) !!}
                           @isset($user)
                               {{ Form::hidden('user_id',$user->id) }}
                           @endisset
                           <button type="button" class="btn btn-primary btn-xs" id="edit"><span class="fa fa-edit"></span> Edit Doc</button>
                           <script>

                           </script>
                           <br><br>
                           <button type="button" class="btn btn-primary btn-xs" id="openDeleteModal"><span class="fa fa-trash-o"></span> Delete Doc</button>
                           <script>
